...
<!-- ROCI is meant for educational and research purposes only. -->
...
ROCI represents a loose collection of algorithms, not a coherent Python library. Such a python library is under development as a separate project, temporarily being housed in this repo under [`rocilib`](rocilib). 
...
- [ESPIRiT parallel-imaging](algorithms/espirit/)
...
- [PnP-CoSMo: Plug-and-play reconstruction based on content/style modeling](https://www.sciencedirect.com/science/article/pii/S136184152600229X)
